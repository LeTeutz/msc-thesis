...
class DatasetLoader:
    ...
    def load_dataset(self,
        ...
        # elif dataset_name == "mnist_1k":
        #     train_full = MNISTReduced1k(root="./data", train=True, download=True, transform=base_transform)
        #     test_full = MNISTReduced1k(root="./data", train=False, download=True, transform=base_transform)
        elif dataset_name == "mnist_100":
            train_full = MNISTReduced100(root="./data", train=True, download=True, transform=base_transform)
            test_full = MNISTReduced100(root="./data", train=False, download=True, transform=base_transform)
